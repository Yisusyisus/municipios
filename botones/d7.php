...
if(isset($_POST["submit"])){
    ...
    if($seccion==$seccion){
        $sql="SELECT * FROM d7 WHERE seccion='$seccion'";
        $result= mysqli_query($conn, $sql);
        if(!$result->num_rows > 0){
            
            $sql="INSERT INTO d7 (seccion,municipio,representante)
	...
	<div class="container">
        ...
        <p class="text-center" style="font-size: 2rem; font-weight: 800;">Registro</p>
            ...
            <br>
                ...
                <a class="btn btn-danger regular-button" href="dist7.php" role="button"> REGRESAR </a>
			</div>			
		</form>
	</div>
</body>
