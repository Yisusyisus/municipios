...
<html lang="en">
    ...
    <body>
            ...
            <div class="container mt-5">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizard9.php?id=<?php echo $row['seccion'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="deleted9.php?id=<?php echo $row['seccion'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
                        ...
                        <br>
                        <a class="btn btn-primary regular-button" href="d9.php" role="button"> INSERTAR </a>
