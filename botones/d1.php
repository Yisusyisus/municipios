...
if(isset($_POST["submit"])){
    ...
    if($seccion==$seccion){
        $sql="SELECT * FROM d1 WHERE seccion='$seccion'";
        $result= mysqli_query($conn, $sql);
        if(!$result->num_rows > 0){
            
            $sql="INSERT INTO d1 (seccion,municipio,representante)
	...
	<div class="container">
        ...
        <p class="text-center" style="font-size: 2rem; font-weight: 800;">Registro</p>
            ...
            <br>
                ...
                <a class="btn btn-danger regular-button" href="dist1.php" role="button"> REGRESAR </a>
			</div>			
		</form>
	</div>
</body>
